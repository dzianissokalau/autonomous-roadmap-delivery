...
- Use `codex/framework-core-and-release-readiness-phase-<n>` branches for
...
- Do not push, promote to `main`, merge, delete branches, install/sync the
  global Codex skill, or run destructive commands without explicit human
  approval.
...
- create or reuse the correct
  `codex/framework-core-and-release-readiness-phase-<n>` branch when
...
- update `automation/framework-core-and-release-readiness/delivery_log.md` and
  `automation/framework-core-and-release-readiness/delivery_state.json`
- perform a skeptical review from fresh context where available
- write review output under `automation/framework-core-and-release-readiness/reviews/`
